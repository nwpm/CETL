...
void test_cstl_list_create() {
  ...
  cstl_list *l = cstl_list_create(&elem, sizeof(int));
...
void test_cstl_list_create_data_struct() {
  ...
  cstl_list *l = cstl_list_create(elem, sizeof(TestStruct));
...
void test_cstl_list_create_elem_size_zero() {
  ...
  cstl_list *l = cstl_list_create(&elem, 0);
...
void test_cstl_list_create_copy() {
  ...
  for (size_t i = 0; i < 4; ++i) {
    cstl_list_push_back(l, &elem, sizeof(int));
  }

  cstl_list *c_l = cstl_list_create_copy(l);
...
void test_cstl_list_create_copy_from_empty() {
...
void test_cstl_list_create_copy_from_null() {

  cstl_list *c_l = cstl_list_create_copy(NULL);

  TEST_ASSERT_NULL(c_l);
}

void test_cstl_list_create_copy_independent() {
...
void test_cstl_list_push_back_not_empty_list() {
  ...
  TEST_ASSERT_NOT_NULL(cstl_list_push_back(l, &elem_new, sizeof(int)));
...
void test_cstl_list_push_back_empty_list() {
  ...
  TEST_ASSERT_NOT_NULL(cstl_list_push_back(l, &elem, sizeof(int)));
...
void test_cstl_list_push_front_not_empty_list() {
  ...
  TEST_ASSERT_NOT_NULL(cstl_list_push_front(l, &elem_new, sizeof(int)));
...
void test_cstl_list_push_front_empty_list() {
  ...
  TEST_ASSERT_NOT_NULL(cstl_list_push_front(l, &elem, sizeof(int)));
...
void test_cstl_list_pop_back_not_empty_list() {
  ...
  cstl_list *l = cstl_list_create(&first_elem, sizeof(int));

  TEST_ASSERT_NOT_NULL(l);

  int second_elem = 7;

  TEST_ASSERT_NOT_NULL(cstl_list_push_back(l, &second_elem, sizeof(int)));
...
void test_cstl_list_insert_pos_begin() {
  ...
  TEST_ASSERT_NOT_NULL(cstl_list_insert(l, &second_elem, 0, sizeof(int)));
...
void test_cstl_list_insert_size_zero() {
  ...
  TEST_ASSERT_NOT_NULL(cstl_list_insert(l, &elem, 0, sizeof(int)));
...
void test_cstl_list_insert_pos_end() {
  ...
  TEST_ASSERT_NOT_NULL(
      cstl_list_insert(l, &second_elem, l->size, sizeof(int)));
...
void test_cstl_list_insert_pos_out_of_bound() {
  ...
  TEST_ASSERT_NULL(cstl_list_insert(l, &second_elem, 100, sizeof(int)));
...
void test_cstl_list_insert_pos_middle() {
  ...
  cstl_list_push_back(l, &second_elem, sizeof(int));

  int third_elem = 9;

  TEST_ASSERT_NOT_NULL(
      cstl_list_insert(l, &third_elem, l->size / 2, sizeof(int)));
...
void test_cstl_list_erase_pos_begin() {
  ...
  for(int i = 0; i < 5; ++i){
    cstl_list_push_back(l, &i, sizeof(int));
  }
...
void test_cstl_list_erase_pos_middle() {
  ...
  TEST_ASSERT_EQUAL_size_t(4, l->size);
  TEST_ASSERT_EQUAL_size_t(sizeof(int), l->elem_size);
  TEST_ASSERT_EQUAL_INT(3, *((int*)cstl_list_get(l, 2)));
...
void test_cstl_list_merge_two_both_not_empty() {

  int l1_elem = 1;

  cstl_list *l1 = cstl_list_create(&l1_elem, sizeof(int));

  TEST_ASSERT_NOT_NULL(l1);

  for (size_t i = 0; i < 4; ++i) {
    cstl_list_push_back(l1, &l1_elem, sizeof(int));
  }

  int l2_elem = 2;

  cstl_list *l2 = cstl_list_create(&l2_elem, sizeof(int));

  TEST_ASSERT_NOT_NULL(l2);

  for (size_t i = 0; i < 4; ++i) {
    cstl_list_push_back(l2, &l2_elem, sizeof(int));
  }

  cstl_list *merged = cstl_list_merge_two(l1, l2);
  ...
  cstl_list_free(l1);
  cstl_list_free(l2);
  cstl_list_free(merged);
}

void test_cstl_list_merge_two_one_empty() {

  cstl_list *l1 = cstl_list_create_empty();
...
void test_cstl_list_merge_two_both_empty() {

  cstl_list *l1 = cstl_list_create_empty();

  TEST_ASSERT_NOT_NULL(l1);

  cstl_list *l2 = cstl_list_create_empty();
...
void test_cstl_list_clear() {
  ...
  TEST_ASSERT_NOT_NULL(cstl_list_clear(l));
...
void test_cstl_list_clear_double_clear() {
...
void test_cstl_list_set(){
  ...
  TEST_ASSERT_NOT_NULL(cstl_list_set(l, 0, &s_elem));
  TEST_ASSERT_EQUAL_INT(s_elem, *((int*)l->head->data));

  cstl_list_free(l);
}

void test_cstl_list_set_out_of_bounds(){
  ...
  int s_elem = 1;
  TEST_ASSERT_NULL(cstl_list_set(l, 100, &s_elem));

  cstl_list_free(l);
}

void test_cstl_list_get_pos_begin(){
...
void test_cstl_list_get_pos_end(){
  ...
  void *elem = cstl_list_get(l, l->size - 1);
...
void test_cstl_list_get_pos_middle(){
  ...
  void *elem = cstl_list_get(l, l->size / 2);
...
void test_cstl_list_get_pos_out_of_bounds(){
...
int main() {
  ...
  RUN_TEST(test_cstl_list_create_copy);
  RUN_TEST(test_cstl_list_create_copy_from_empty);
  RUN_TEST(test_cstl_list_create_copy_from_null);
  RUN_TEST(test_cstl_list_create_copy_independent);
  ...
  RUN_TEST(test_cstl_list_merge_two_both_not_empty);
  RUN_TEST(test_cstl_list_merge_two_one_empty);
  RUN_TEST(test_cstl_list_merge_two_both_empty);

  printf("\n");

  RUN_TEST(test_cstl_list_clear);
  RUN_TEST(test_cstl_list_clear_double_clear);

  printf("\n");

  RUN_TEST(test_cstl_list_set);
  RUN_TEST(test_cstl_list_set_out_of_bounds);

  printf("\n");

  RUN_TEST(test_cstl_list_get_pos_begin);
  RUN_TEST(test_cstl_list_get_pos_end);
  RUN_TEST(test_cstl_list_get_pos_middle);
  RUN_TEST(test_cstl_list_get_pos_out_of_bounds);
