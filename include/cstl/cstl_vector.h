...
cstl_vector *cstl_vec_insert(cstl_vector *vec, size_t pos, const void *new_val);
...
size_t cstl_vec_size(const cstl_vector *vec);
size_t cstl_vec_capacity(const cstl_vector *vec);

bool cstl_vec_is_empty(const cstl_vector *vec);
